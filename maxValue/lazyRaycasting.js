	...
	function draw(){
		...
		for(var z = 0; z < zSize; z++){
			for(var s = 0; s < sampleCount; s++){
				...
				cutImageData.data[z*cutImageData.width*4 + s*4+0] = max;
				cutImageData.data[z*cutImageData.width*4 + s*4+1] = max;
				cutImageData.data[z*cutImageData.width*4 + s*4+2] = max;
